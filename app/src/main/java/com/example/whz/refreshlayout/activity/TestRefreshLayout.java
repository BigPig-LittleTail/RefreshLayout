...
/**
 * The TestRefreshLayout should be used whenever the user can refresh the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The TestRefreshLayout
 ...
 * width and the height supplied in this layout. The TestRefreshLayout does not
...
public class TestRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private static final String LOG_TAG = TestRefreshLayout.class.getSimpleName();
    ...
    TestRefreshLayout.OnRefreshListener mListener;
    ...
    /**
     * Simple constructor to use when creating a TestRefreshLayout from code.
     *
     * @param context
     */
    ...
    /**
     * Constructor that is called when inflating TestRefreshLayout from XML.
     *
     * @param context
     * @param attrs
     */
    ...
    public interface OnChildScrollUpCallback {
         ...
         *
         * @param parent TestRefreshLayout that this callback is overriding.
         * @param child The child view of TestRefreshLayout.
         *
         * @return Whether it is possible for the child view of parent layout to scroll up.
         */
        boolean canChildScrollUp(TestRefreshLayout parent, @Nullable View child);
    }
}
